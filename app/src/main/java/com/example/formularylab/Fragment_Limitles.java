 ...
 * {@link Fragment_Limitles.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Fragment_Limitles#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Fragment_Limitles extends Fragment {
     ...
     * @return A new instance of fragment Fragment_Limitles.
     */
    // TODO: Rename and change types and number of parameters
    public static Fragment_Limitles newInstance(String param1, String param2) {
        Fragment_Limitles fragment = new Fragment_Limitles();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista=inflater.inflate(R.layout.fragment_fragment__limitles, container, false);
        navigator=(Button) vista.findViewById(R.id.bt_limitles_more);
        save=(Button) vista.findViewById(R.id.bt_limitles_save);
        imagen=(ImageView) vista.findViewById(R.id.iv_limitles_image);
        LoadImagen();
        ...
        navigator.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String page_web="https://es.wikipedia.org/wiki/L%C3%ADmite_de_una_funci%C3%B3n";
    ...
    private void LoadImagen(){
        Glide.with(this)
                .load("http://192.168.100.116:80/limitles.PNG")
                .into(imagen);
