 ...
 * {@link Fragment_Vectores.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Fragment_Vectores#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Fragment_Vectores extends Fragment {
     ...
     * @return A new instance of fragment Fragment_Vectores.
     */
    // TODO: Rename and change types and number of parameters
    public static Fragment_Vectores newInstance(String param1, String param2) {
        Fragment_Vectores fragment = new Fragment_Vectores();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista=inflater.inflate(R.layout.fragment_fragment__vectores, container, false);
        navigator=(Button) vista.findViewById(R.id.bt_vectors_more);
        save= (Button) vista.findViewById(R.id.bt_vectors_save);
        imagen= (ImageView) vista.findViewById(R.id.iv_vectors_image);
        LoadImagen();
        ...
        navigator.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String page_web="https://es.wikipedia.org/wiki/Vector";
    ...
    private void LoadImagen(){
        Glide.with(this)
                .load("http://192.168.100.116:80/vectors.JPG")
                .into(imagen);
