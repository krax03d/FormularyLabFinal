 ...
 * {@link Fragment_Trigo_Seno.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Fragment_Trigo_Seno#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Fragment_Trigo_Seno extends Fragment {
     ...
     * @return A new instance of fragment Fragment_Trigo_Seno.
     */
    // TODO: Rename and change types and number of parameters
    public static Fragment_Trigo_Seno newInstance(String param1, String param2) {
        Fragment_Trigo_Seno fragment = new Fragment_Trigo_Seno();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista=inflater.inflate(R.layout.fragment_fragment__trigo__seno, container, false);
        navigator=(Button) vista.findViewById(R.id.bt_trigo_seno_more);
        save=(Button) vista.findViewById(R.id.bt_trigo_seno_save);
        imagen=(ImageView) vista.findViewById(R.id.iv_trigo_seno_image);
        LoadImagen();
        ...
        navigator.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String page_web="https://es.wikipedia.org/wiki/Seno_(trigonometr%C3%ADa)";
    ...
    private void LoadImagen(){
        Glide.with(this)
                .load("http://192.168.100.116:80/trigo_seno.JPG")
                .into(imagen);
